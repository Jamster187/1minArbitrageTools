    ...
    while attempt < retries:
        try:
            conn = psycopg2.connect(
                host=independentreserve_DB_HOST,
                database=independentreserve_DB_NAME,
                user=independentreserve_DB_USER,
                password=independentreserve_DB_PASSWORD
            )
            return conn
    ...
    while True:
        ...
        try:
            ...
            for symbol in markets:
                ...
                table_name = f"independentreserve_{symbol.replace('/', '_').lower()}_1m"
