    ...
    while attempt < retries:
        try:
            conn = psycopg2.connect(
                host=CRYPTOCOM_DB_HOST,
                database=CRYPTOCOM_DB_NAME,
                user=CRYPTOCOM_DB_USER,
                password=CRYPTOCOM_DB_PASSWORD
            )
            return conn
    ...
    while True:
        ...
        try:
            ...
            for symbol in markets:
                ...
                table_name = f"cryptocom_{symbol.replace('/', '_').lower()}_30m"
