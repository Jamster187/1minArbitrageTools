...
#Kraken Sol ETH 
run_command "cd ~/Desktop/New_CCXT_Project/cryptocrypto/krakensoleth; python3 buy_entry_bot_kraken.py"
run_command "cd ~/Desktop/New_CCXT_Project/cryptocrypto/krakensoleth; python3 sell_close_bot_kraken.py"
